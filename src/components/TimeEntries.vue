...
<template>
  <div>
    ...
    <div class="time-entries">
      <p v-if="!pagelist.length"><strong>还没有任何文章</strong></p>

      <div class="list-group">
      <!--
        v-for循环，注意参数顺序为(item,index) in items
      -->
        <a class="list-group-item" v-for="(page,index) in pagelist">
          <div class="row">
            ...
            -->
              ...
              <img :src="page.pageImage" class="avatar img-circle img-responsive" />
              <p class="text-center">
                <strong>
                  {{ page.name }}
                </strong>
    ...
    export default {
        ...
        methods : {
          deletePage(idx) {
            // 稍后再来说这里的方法
            // 减去总文章篇數
            this.$store.dispatch('decTotalPageCount',1)
            // 删除该计划
            this.$store.dispatch('deletePage',idx)
          }
        }
    }
</script>
